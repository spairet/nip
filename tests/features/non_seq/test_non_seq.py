...
def test_simple_non_seq():
    ...
    expected = {
        "main": {"just": "some", "values": 123},
        "other_main": {"just": "some", "values": 123},
    }
...
def test_harder_non_seq():
    ...
    expected = {
        ...
        "other_main": {"interesting": [4, 5, 6, 7], "here_is_the_ll": 6},
    }
    assert output == expected
...
def test_part_harder_non_seq():
    ...
    expected = {"interesting": [4, 5, 6, 7], "here_is_the_ll": 6}
...
def test_inline_non_seq():
    ...
    expected = {
        "main": ["some f string with var 12", 123, {"items": [4, 5, 6, 12]}],
        "other_main": {"iteresting": [4, 5, 6, 12], "here_is_the_ll": 6},
        "inline_python": 2.5,
        "t": 5,
    }
    assert output == expected
